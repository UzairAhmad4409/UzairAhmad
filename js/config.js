/**
 * ============================================================
 * PORTFOLIO CONFIG — edit your personal details HERE only
 * ============================================================
 * Replace YOUR_* placeholders with your real info.
 * Hero, contact, footer, and CV buttons update automatically.
 * ============================================================
 */
const portfolioConfig = {
  ...
  // Used in SEO / Open Graph if needed
  siteDescription:
    "Portfolio of Uzair Ahmad, a Unity Game Developer specializing in gameplay programming, multiplayer systems, PlayFab, Photon, UI/UX and mobile/WebGL game development.",
};
